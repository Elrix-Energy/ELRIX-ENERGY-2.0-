      ...
      <div className="container text-center">
        ...
        <div className="guarantees-grid" style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(300px, 1fr))', gap: '2rem' }}>
          <div className="guarantee-card glass" style={{ padding: '2.5rem', borderRadius: '16px', textAlign: 'center', background: 'white', border: '1px solid rgba(0,0,0,0.05)' }}>
            <h3 style={{ fontSize: '3rem', color: 'var(--primary)', marginBottom: '1rem', lineHeight: 1 }}>25<span style={{ fontSize: '1.5rem' }}>YR</span></h3>
            <h4 style={{ marginBottom: '0.5rem' }}>Linear Performance Warranty</h4>
          ...
          <div className="guarantee-card glass" style={{ padding: '2.5rem', borderRadius: '16px', textAlign: 'center', background: 'white', border: '1px solid rgba(0,0,0,0.05)' }}>
            <h3 style={{ fontSize: '3rem', color: 'var(--primary)', marginBottom: '1rem', lineHeight: 1 }}>10<span style={{ fontSize: '1.5rem' }}>YR</span></h3>
            <h4 style={{ marginBottom: '0.5rem' }}>Product Warranty on Inverters</h4>
          ...
          <div className="guarantee-card glass" style={{ padding: '2.5rem', borderRadius: '16px', textAlign: 'center', background: 'white', border: '1px solid rgba(0,0,0,0.05)' }}>
            <h3 style={{ fontSize: '3rem', color: 'var(--primary)', marginBottom: '1rem', lineHeight: 1 }}>5<span style={{ fontSize: '1.5rem' }}>YR</span></h3>
            <h4 style={{ marginBottom: '0.5rem' }}>Comprehensive Workmanship</h4>
